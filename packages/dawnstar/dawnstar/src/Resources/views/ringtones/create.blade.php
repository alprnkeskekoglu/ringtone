        ...
        <div class="content">
            <div class="block block-rounded block-bordered">
                <div class="block-content">
                    <form action="{!! route("panel.ringtone.store") !!}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row push">
                            ...
                            <div class="col-lg-9 col-xl-8">
                                <div class="row">
                                    ...
                                    <div class="form-group mt-5">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="number" class="form-control" id="download_count" disabled
                                                   name="download_count">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ringtone_name" name="name"
                                           autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label>Ringtone Slug</label>
                                    <input type="text" class="form-control" id="ringtone_slug" name="slug">
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    <script
        src="{!! asset("vendor/dawnstar/js/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js") !!}"></script>
    <script>
